...
data = {"weather":{"value":wea,"color":"#737CA1"},"temperature":{"value":temperature,"color":"#728FCE"},"love_days":{"value":get_count(),"color":"#F67280"},"his_birthday_left":{"value":get_his_birthday(),"color":get_random_color()},"her_birthday_left":{"value":get_her_birthday(),"color":get_random_color()},"words":{"value":"瞳瞳的梦想是当公主✌️！","color":"#F2BB66"}}
count = 0
